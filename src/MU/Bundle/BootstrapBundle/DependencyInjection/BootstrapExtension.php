...
namespace MU\Bundle\BootstrapBundle\DependencyInjection;
...
class BootstrapExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function prepend(ContainerBuilder $container)
    {
        ...
        if (!isset($bundles['TwigBundle']) || !isset($bundles['AsseticBundle'])) {
            throw new \Exception('Missing required TwigBundle or AsseticBundle for MUBootstrapBundle.');
        }

        // add the form builder to the twig form resources
        $config = ['form_themes' => ['BootstrapBundle:form:bootstrap_3_layout.html.twig']];
